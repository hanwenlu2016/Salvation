...
$('body').append('' +
    '<div class="fixed-button">' + '<a href="https://github.com/hanwenlu2016" target="_blank" class="btn btn-md btn-primary">' + '<i class="fa fa-rocket" aria-hidden="true"></i> My GitHub' +
    '</a> ' + '</div>' + '');
var $window = $(window);
